...
# load images
explosion_image = pygame.image.load('./IP_Project/explosion.png')
hit_image = pygame.image.load('./IP_Project/hit.png')
miss_image = pygame.image.load('./IP_Project/splash.png')
ship_image_carrier = pygame.image.load('./IP_Project/battleships carrier.png')
ship_image_large = pygame.image.load('./IP_Project/battleships large.png')
ship_image_medium = pygame.image.load('./IP_Project/battleships medium.png')
ship_image_small = pygame.image.load('./IP_Project/battleships small.png')
